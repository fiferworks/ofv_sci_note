...
**We have adjusted some wording, organization, and grammar of the manuscript in an attempt to aid clarity and accuracy. We also reviewed and corrected some citations.**

**We rewrote the sections describing sampling methods and diagnostics in the abstract and main text. Both samples from Leon County and Alachua were found to be positive for OFV; only samples from Leon were examined for mites. We have removed the claim that the virus is widespread.**

Specific Edits: 

- Added discussion on why OFV has not been reported in nearby citrus.
- We have removed all references to cileviruses
- We have corrected inconsistencies with taxonomic authorities
- We have not added a discussion of potential control measures due to word limits, and lack of specific documentation regarding control methods/chemical applications for these specific ornamental plants.

Also: 
L33: “Orchid fleck virus (OFV) is a dichorhavirus that infects over 50 plant species belonging to the families Asparagaceae, Orchidaceae, and Rutaceae.  The only known vectors for…” $\rightarrow$ **rewritten**


L37: (Liriope and Ophiopogon spp.) $\rightarrow$ **fixed**

L40: “…Sanger sequencing.” $\rightarrow$ **fixed**

L41: remove “the known” and “the NCBI” $\rightarrow$ **fixed**

L42: I see no mention of a qPCR assay in the main text $\rightarrow$ **fixed**

L43: “…possibly infected plants of the family Asparagaceae from…” $\rightarrow$ **rewritten**

L44: please elaborate on “Identification of partial genome sequence…” is this sequence from the PCR products or was HTS performed on the samples? $\rightarrow$ **rewritten**

L48: perhaps identify what s.l. means; authorities are provided elsewhere in the manuscript $\rightarrow$ **sensu lato in this case refers to the fact that it not the specific mite referred to by Baker as *B. californicus*, which has been split into 3 subgroups, but have not been adequately described yet**

L49: italicize “Brevipalpus” $\rightarrow$ **fixed**

L59: Virus species should not be abbreviated; remove “(OFV)” $\rightarrow$ **Is this an acceptable alternative?**

L60: virus families are italicized (Rhabdoviridae) $\rightarrow$ **fixed**

L63: replace “sole” with “only known” $\rightarrow$ **fixed**

L64: “group of mites” vs “sensu lato”? $\rightarrow$ **fixed**

L69: I don’t think referencing figures 1 and 2 are appropriate here $\rightarrow$ **fixed**

L73,76: is listing the second author the correct way to distinguish articles for this journal?  Rather than “a” or “b” after publication year? $\rightarrow$ **citation manager error, fixed**

L77: remove “: (Citrus) $\rightarrow$ **fixed**

L78: Olmedo-Velarde et al. is not an appropriate reference here $\rightarrow$ **citation should have been @Velarde2021, fixed**

L82: “In June 2020,…”; (Lirope spp.) $\rightarrow$ **fixed**

L83: belongs $\rightarrow$ **fixed**

L85: perhaps “monocotyledonous liliod plants native to southeastern Asia (Chase…” $\rightarrow$ **fixed**

L86: is it appropriate to provide an authority for the genus (Ker Gawler)? $\rightarrow$ **fixed**

L92: none of these virus names should be italicized; INSV and TSWV are orthotospoviruses – why mentioned separately? $\rightarrow$ **I believe that these were specific tests, fixed**

L97: “…as well as Aspidistra elaitor Blume (Asparagaceae), which was suspected…” $\rightarrow$ **fixed, *A. elatior***

L103: “Lirope sp.” $\rightarrow$ **fixed**

L108: how many sites? $\rightarrow$ **There are multiple sites with OFV-infected plants in Leon County, and one site identified in Alachua County. The plant samples tested from Leon Co. were taken from the first site where the pathogen was found.**

L127: This is incorrect: Blanchfield et al 2001 identified a virion larger than OFV, and the sample was negative for OFV when tested by RT-PCR. $\rightarrow$ **Thank you for correcting this mistake, fixed**

L134: Nolinoideae $\rightarrow$ **fixed**

L145: The ICTV is not responsible for classification below species level, and as such, does not recognize virus strains; scientists and experts can recognize strains, but the  ICTV does not. $\rightarrow$ **fixed**

L152: “including Vanilla spp. in southern Florida…” $\rightarrow$ **clarified**

L154: a reference for this statement is advisable  $\rightarrow$ **clarified**

L155: “…found that the virus which previously affected…”  $\rightarrow$ **clarified**

L165: “…vectors of dichorhaviruses (Knorr 1968,…” $\rightarrow$ **clarified**

L168: “…identify the vector(s) of OFV in Florida…” $\rightarrow$ **clarified**

Table 1:
L338: “…with symptoms of orchid fleck virus infection found in…”
I am a little concerned about reporting on plants with symptoms, vs confirmed by diagnostics.  As mentioned earlier, different dichorhaviruses can cause similar symptoms in the same host.  Although remote, there is the possibility another virus could be responsible for the symptoms in a different location $\rightarrow$ **clarified in text**

Figure captions:
Please use “orchid fleck virus (OFV)” when describing a physical virus, and "Orchid fleck dichorhavirus" (in italics) when describing the species. $\rightarrow$ **fixed**
...
**We have removed references to a 'wide distribution' in Florida, corrected species names and inconsistencies with citations. We are grateful for your assistance.**
...
- L321 - We do not believe it is necessary to italicize the plant family 'Asparagaceae'