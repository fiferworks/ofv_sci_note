...
OFV-infected plants exhibit various symptoms depending on the infected plant species as well as the strain of the OFV [@Kubo2009b], but symptoms typically appear as chlorotic flecks, which ultimately coalesce into larger spots or ringspot patterns (`r citef("fig_1")`).
