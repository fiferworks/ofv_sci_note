...
### Figure captions
`r fig_nums(name = "fig_1", caption = "Variety of symptoms expressed by *Liriope* spp. infected with orchid fleck virus (OFV): (a) ringspot symptoms on *Liriope muscari* cv. 'Gigantea' (b-c) Details of ringspot symptoms on *L. muscari* cv. 'Gigantea' (d) rust colored spots on *Ophiopogon intermedius*")`
