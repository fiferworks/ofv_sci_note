...
output: 
  word_document:
    reference_docx: word-template-jis.docx
# - html_document
...
### Figure captions
`r fig_nums(name = "fig_1", caption = "Variety of symptoms seen on *Liriope* spp. infected with orchid fleck virus (OFV): (a) symptoms on *Liriope muscari* cv. 'Gigantea' (b-c) Details of symptoms on *L. muscari* cv. 'Gigantea' (d) rust colored spots on *Ophiopogon intermedius*")`

`r fig_nums(name = "fig_2", caption = "Symptoms seen on *Aspidistra elatior* infected with OFV: (a) Detail of leaf chlorosis (b) Chlorosis appears similar to sun damage (c-d) Chlorotic flecks may indicate early symptoms of OFV")`
